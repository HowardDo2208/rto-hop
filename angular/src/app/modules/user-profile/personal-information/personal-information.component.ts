...
export class PersonalInformationComponent implements OnInit, OnDestroy {
  ...
  loadForm() {
    this.formGroup = this.fb.group({
      pic: [this.user.userImagePath],
      firstname: [this.user.userFullName, Validators.required],
      phone: [this.user.noticeMobile, Validators.required],
      email: [this.user.noticeEmail, Validators.compose([Validators.required, Validators.email])],
    });
  }
  ...
  getPic() {
    ...
    return `url('${this.user.userImagePath}')`;
  }
